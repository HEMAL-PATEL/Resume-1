 ...
 * on 2015-01-06 at 13:02:26 UTC 
 * Modify at your own risk.
 */

package im.ene.lab.resume.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class SayHi extends MyApiRequest<im.ene.lab.resume.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, im.ene.lab.resume.backend.myApi.model.MyBean.class);
