...
public class ResumeReasonFragment extends ResumeBaseFragment {

	public ResumeReasonFragment() {
		// TODO Auto-generated constructor stub
	}

	public static ResumeBaseFragment newInstance() {
		ResumeBaseFragment fragment = new ResumeReasonFragment();
		return fragment;
	}
	...
	public View onCreateView(LayoutInflater inflater,
		...
		View rootView = inflater.inflate(R.layout.fragment_cv_reason, container,
				false);
